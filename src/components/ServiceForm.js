...
export default function ServiceForm({ dispatch, editingService }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="service-form">
            <div>
                <label>Title</label>
                <input type="text" value={title} className="search-input" onChange={(e) => setTitle(e.target.value)} placeholder="Service Title" />
            </div>
            <div>
                <label>Description</label>
                <textarea type="text" value={description} className="search-input" onChange={(e) => setDescription(e.target.value)} placeholder="Service Description" />
            </div>
